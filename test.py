...
# ------------------------------
    ...
    st.write("물리치료는 **통증을 줄이고 근육과 관절의 기능을 회복**시키며, **재활을 돕는 치료 방법**입니다. 🏃‍♀️")
             caption="물리치료 예시", use_column_width=True)
...
# ------------------------------
    ...
    st.write("작업치료는 **일상생활에 필요한 활동(옷 입기, 식사, 글쓰기 등)을 스스로 할 수 있도록 돕는 치료**입니다. 🖐")
             caption="작업치료 예시", use_column_width=True)
...
# ------------------------------
    ...
    # 이미지 예시 (허리 스트레칭)
    st.image("images/stretch.jpg", caption="허리 스트레칭 따라하기")

    # 유튜브 동영상 예시
    st.video("https://www.youtube.com/watch?v=2L2lnxIcNmo")  # 허리 운동 영상 링크
...
# ------------------------------
    ...
    # 손 운동 이미지
    st.image("images/hand_exercise.png", caption="손가락 스트레칭 훈련")

    # 작업치료 관련 유튜브 영상
    st.video("https://www.youtube.com/watch?v=l4R5iWaaVxw")  # 손 운동 훈련 영상 링크
