...
symptom_exercise = {
    "두통": """
- 목 스트레칭: 천천히 좌우 10회
- 어깨/목 근육 이완: 어깨 위로 올렸다 내리기 10회
- 가벼운 산책: 5~10분
- 눈 깜박임 운동: 화면 집중 후 20초마다 10번
- 심호흡 운동: 깊게 들이마시고 내쉬기 5회
""",
    "기침": """
- 심호흡 운동: 코로 깊게 들이마시고 입으로 내쉬기 10회
- 가벼운 전신 스트레칭: 팔, 다리, 몸통 스트레칭 5~10분
- 목 근육 풀기: 목 좌우 돌리기 10회, 어깨 회전 10회
""",
    "복통": """
- 복부 마사지: 시계 방향으로 2~3분 원 그리며 마사지
...
""",
    "발목통증": """
- 발목 돌리기: 시계/반시계 방향 10회
- 발목 밴드 운동: 외번/내번 10회
- 균형 잡기: 한 발로 서기 30초, 양쪽 반복
- 보조기 착용: 안정성 확보
""",
    "눈충혈": """
- 눈 깜박임 운동: 화면 집중 후 10번
- 시선 좌우/상하 이동: 10회씩
- 눈 근육 스트레칭: 손바닥 온찜질 30초
- 휴식: 20-20-20 규칙(20분마다 20초, 20피트)
"""
}
...
drug_info = {
    "타이레놀": {"효능": "경증~중등도 통증 완화, 해열 작용, 간 부담 적음", "부작용": "과다 복용 시 간 손상, 드물게 알레르기"},
    "이부프로펜": {"효능": "진통 및 염증 완화, 근육통/관절염 효과", "부작용": "위장 장애, 어지러움, 장기 사용 시 신장 기능 저하 가능"},
    "아세트아미노펜": {"효능": "통증 완화 및 해열", "부작용": "과량 복용 시 간 손상, 장기 복용 시 간 기능 주기적 확인 필요"},
    "진통제": {"효능": "통증 완화용, 두통/근육통/생리통에 사용", "부작용": "위장 장애, 어지러움"},
    "진해거담제": {"효능": "기침 억제 및 가래 배출 도움", "부작용": "졸림, 어지러움, 소화 불량 가능"},
    "항히스타민제": {"효능": "알레르기 증상 완화", "부작용": "졸림, 구강 건조, 드물게 두통/심계항진"},
    "기침완화 시럽": {"효능": "마른 기침 억제, 목 통증 완화", "부작용": "졸림, 드물게 위장 장애"},
    "기관지 확장제": {"효능": "천식 및 기관지 수축 완화, 호흡 개선", "부작용": "심계항진, 떨림, 불면, 드물게 흉통"},
    "판토덱스": {"효능": "위산 억제, 소화불량 완화, 위염 치료 도움", "부작용": "두통, 복통, 드물게 설사/발진"},
    "소염제": {"효능": "염증 완화, 근육통/관절염 사용", "부작용": "위장 장애, 드물게 피부 발진, 장기 복용 시 신장 부담"},
    "소화제": {"효능": "소화 기능 개선, 식후 더부룩함 완화", "부작용": "복
import streamlit as st
...
# 증상별 추천 운동
symptom_exercise = {
    "두통": "목 스트레칭, 어깨/목 근육 이완, 심호흡, 가벼운 산책, 눈 깜박임 운동",
    "기침": "심호흡 운동, 가벼운 전신 스트레칭, 목 근육 풀기",
    "복통": "복부 마사지, 복부 스트레칭, 요가 자세, 가벼운 걷기",
    "발열": "휴식 위주, 무리한 운동 금지, 가벼운 스트레칭 가능",
    "피로감": "전신 스트레칭, 걷기, 목/어깨 근육 풀기, 심호흡 운동",
    "발목통증": "발목 돌리기, 발목 밴드 운동, 보조기 착용, 균형 잡기 운동",
    "눈충혈": "눈 깜박임, 시선 좌우/상하 이동, 눈 근육 스트레칭, 휴식"
}
...
drug_info = {
    ...
    "아세트아미노펜": {"효능": "진통, 해열", "부작용": "간 손상"},
    "진통제": {"효능": "통증 완화", "부작용": "위장 장애, 어지러움"},
    "진해거담제": {"효능": "기침 완화", "부작용": "졸림, 어지러움"},
    "항히스타민제": {"효능": "알레르기 완화", "부작용": "졸림, 구강 건조"},
    "기침완화 시럽": {"효능": "기침 완화", "부작용": "졸림"},
    "기관지 확장제": {"효능": "호흡 개선", "부작용": "심계항진, 떨림"},
    "판토덱스": {"효능": "위산 억제제", "부작용": "두통, 복통"},
    "소염제": {"효능": "염증 완화", "부작용": "위장 장애, 발진"},
    "소화제": {"효능": "소화 개선", "부작용": "복부 팽만감"},
    "제산제": {"효능": "위산 중화", "부작용": "변비, 설사"},
    "해열제": {"효능": "발열 감소", "부작용": "위장 장애, 두통"},
    "비타민제": {"효능": "영양 보충", "부작용": "과다 섭취 시 위장장애"},
    "진정제": {"효능": "스트레스 완화", "부작용": "졸림, 어지러움"},
    "철분제": {"효능": "빈혈 개선", "부작용": "변비, 위장 장애"},
    "근육 이완제": {"효능": "근육 경직 완화", "부작용": "졸림"},
    "인공눈물": {"효능": "눈 건조 완화", "부작용": "일시적 눈 따가움"},
    "점안제": {"효능": "알레르기 증상 완화", "부작용": "일시적 시야 흐림"}
}
