...
drug_info = {
    ...
    "소화제": {"효능": "소화 기능 개선, 식후 더부룩함 완화", "부작용": "복부 팽만감, 드물게 설사/변비"},
    "제산제": {"효능": "위산 중화, 속쓰림 완화", "부작용": "변비, 설사, 드물게 복부 불편감"},
    "해열제": {"효능": "발열 감소, 두통/근육통 동반 시 완화", "부작용": "위장 장애, 드물게 두통 또는 간 부담"},
    "비타민제": {"효능": "영양 보충, 피로 회복, 면역 기능 보조", "부작용": "과다 섭취 시 위장 장애, 설사"},
    "진정제": {"효능": "스트레스 완화, 긴장 완화, 수면 개선 도움", "부작용": "졸림, 어지러움, 장기 복용 시 습관성 가능"},
    "철분제": {"효능": "빈혈 예방 및 개선, 피로 감소", "부작용": "변비, 속쓰림, 드물게 구토"},
    "근육 이완제": {"효능": "근육 경직 완화, 통증 완화, 운동 후 회복 도움", "부작용": "졸림, 어지러움, 드물게 위장 장애"},
    "인공눈물": {"효능": "눈 건조 완화, 눈 피로 감소, 콘택트렌즈 사용 시 도움", "부작용": "일시적 눈 따가움, 드물게 알레르기 반응"},
    "점안제": {"효능": "알레르기 증상 완화, 충혈 감소", "부작용": "일시적 시야 흐림, 드물게 눈 따가움"}
}
